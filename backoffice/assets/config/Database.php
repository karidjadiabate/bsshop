...
class Database{
    ...
    public function getAllRecords4($tableName,$tableName1,$tableName2,$tableName3, $fields='*', $cond='', $orderBy='', $limit='')
    {
        $stmt = $this->pdo->prepare("SELECT $fields FROM $tableName,$tableName1,$tableName2,$tableName3 WHERE  1".$cond." ".$orderBy." ".$limit);
        $stmt->execute();
        $rows = $stmt->fetchAll(PDO::FETCH_ASSOC);
        return $rows;
    }
