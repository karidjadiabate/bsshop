          ...
          <div class="row">
            <div class="col-xl-12">
              <?php if (isset($_REQUEST['msg']) and $_REQUEST['msg'] == "rds") {
                echo '<script type="text/javascript">swal({ title: "Accepté !", text: "Commande supprimée avec succès!", icon: "success", confirmButtonText: "OK" });</script>';
              ...
              <div class="card card-default">
                <form class="mt-5 ml-8 " method="GET">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-4">
                      ...
                      <a href="<?php echo PATH ?>commandes/annules.php" class="btn btn-danger btn-sm ">Reinitialiser</a>
                ...
                <div class="card-header align-items-center">
                  <h2 class="">LISTE DES COMMANDES ANNULEES </h2>
                            ...
                            if (count($allCmdEAV) > 0) {
                              foreach ($allCmdEAV as $val) {
                                ...
                                <tr>
                                  ...
                                  <td class="text-sm"><span class="bg-dark text-white p-3 font-weight-bold ">COMMANDE ANNULEE</span></td>
                                  <td>
                              ...
                              <tr>
                                <td colspan="12"><b>Aucun enregistrement trouvé</b></td>
                              </tr>
                            <?php } ?>
                          </tbody>
                        </table>
