...
$condition .= ' AND orders.statut="L"';
$allCmdEAV = $db->getAllRecords1('orders', 'orders_details', '*,orders.id as idCmd ,orders.created_at as dateCommande,GROUP_CONCAT( orders_details.price SEPARATOR "," ) as priceInOrder,GROUP_CONCAT( orders_details.quantity SEPARATOR "," ) as allQuantity,SUM(price) as allPrice,GROUP_CONCAT( orders_details.products_id SEPARATOR "," ) as AllProducts', 'id', 'orders_id', $condition, 'GROUP BY orders.id,orders.created_at ORDER BY orders.created_at DESC');
            ...
            <div class="col-xl-12">
              ...
              <div class="card card-default">
                <form class="mt-5 ml-8 " method="GET">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-4">
                      ...
                      <a href="<?php echo PATH ?>commandes/livres.php" class="btn btn-danger btn-sm ">Reinitialiser</a>
                ...
                <div class="card-header align-items-center">
                  <h2 class="">LISTE DES COMMANDES LIVREES </h2>
                            ...
                            if (count($allCmdEAV) > 0) {
                              foreach ($allCmdEAV as $val) {
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $val['dateCommande'] ?></td>
                                  <td class="text-sm"><span class="bg-dark text-white p-3 font-weight-bold ">COMMANDE LIVREE</span></td>
                                  <td>
                                    <!-- <a class="btn btn-primary btn-sm" href="printRecu.php?orders_id=<?php echo $val['idCmd']; ?>"target="_blank">Reçu</a> -->
                                    <a class="btn btn-warning btn-sm" onclick='Impression("<?php echo $val["id"] ?>")'>Reçu </a>

                                    <!-- <a class="btn btn-warning btn-sm" href="../../tcpdf/source/printrecu.php?orders_id=<?php //echo $val['id']; 
                                                                                                                            ?>"target="_blank">Reçu </a> -->

                                    <!-- <a class="btn btn-success btn-sm" href="#" onClick="update('<?php //echo $val['id']; 
                                                                                                      ?>')">Livrer</a>
                                  \<a class="btn btn-danger btn-sm" onclick="supprimer('<?php //echo $val['id']; 
                                                                                        ?>')" href="#">Annuler</a>  -->
                                  </td>
                                </tr>
                              <?php }
