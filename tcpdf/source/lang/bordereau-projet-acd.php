...
if(isset($_REQUEST['print']) and $_REQUEST['print']!=""){
    $row    =   $db->getAllRecords('acd','*',' AND statut_acd >= "1" AND print="'.$_REQUEST['print'].'"');
    // var_dump($row);exit;
    $condition = "";
...
<table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="100%" align="center">
    <center>
    <h2 style="color: black;font-size:13px;">Bordereau d'envoi d'Arrêtés de Concession Défintive N°__________/MCLAU/DGUF/DGUFH/{$op_centre}/ <span style="padding: 15px;font-size: 10px;">{$op_code}</span></h2>
  </center>
  </td>
 </tr>
</table>
...
<table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="100%">
    <b><h5 style="color: black;font-weight: bold;font-size:13px;">NB : <span style="margin-left: 20px;">{$nbRow} Projets ACD adressés au Directeur du Domaine Urbain</span></h5></b>
  </td>
 </tr>
</table>
<table class="first" cellpadding="4" cellspacing="6">
...
$pdf->Output('Bordereau-projet-ACD.pdf', 'I');
