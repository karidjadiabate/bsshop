...
if(isset($_REQUEST['print']) and $_REQUEST['print']!=""){
    $row    =   $db->getAllRecords('acd','*',' AND ((statut_ad = "01" OR statut_ad = "03" OR statut_ad = "04") || (statut_acd = "01" OR statut_acd = "03" OR statut_acd = "04" OR statut_acd = "05" OR statut_acd = "07" OR statut_acd = "08")) AND print="'.$_REQUEST['print'].'"');
    $condition = "";
...
$s  =   '<table cellpadding="4" cellspacing="0" border="1">
           <tr>
            ...
            <td width="20%;" align="center">N° AD</td>
           </tr>';
$nb = count($datas);
$i=0;
...
<table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="100%" align="center">
  	<center>
    <h2 style="color: black;font-size:13px;">Bordereau d'envoi des dossiers rejetés  N°__________/MCLAU/DGUF/DGUFH/{$op_centre}/ <span style="padding: 15px;font-size: 10px;">{$op_code}</span></h2>
  </center>
  </td>
 </tr>
</table>
...
<table class="first" cellpadding="4" cellspacing="6">
 <tr>
  <td width="100%">
  	<b><h5 style="color: black;font-weight: bold;font-size:13px;">NB : <span style="margin-left: 20px;">{$nbRow} dossiers rejetés adressés au Directeur du Domaine Urbain</span></h5></b>
  </td>
 </tr>
</table>
<table class="first" cellpadding="4" cellspacing="6">
...
$pdf->Output('Bordereau-dossiers-rejetes.pdf', 'I');
